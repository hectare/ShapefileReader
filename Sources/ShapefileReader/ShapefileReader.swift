...
public class DBFReader {
    ...
    fileprivate func buildDBFRecordFormat() -> String {
        ...
        if totalSize != recordLengthFromHeader {
            print("-- error: record size declared in header \(String(recordLengthFromHeader)) != record size declared in fields format \(totalSize)")
...
public class ShapefileReader {
    ...
    public var dbf: DBFReader?
    public var shx: SHXReader?
